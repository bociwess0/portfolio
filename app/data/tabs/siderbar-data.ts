...
export const allProjects: Project[] = [
  ...
  {
    title: "Places App",
    description: `A full-stack travel platform where users can discover, create, edit, and manage places they have visited, explore destinations shared by other users, upload images, and securely manage their own content. Built with React, TypeScript, Redux Toolkit, Node.js, Express, MongoDB, JWT authentication, Cloudinary, Tailwind CSS, and Material UI.`,
    image: "/Places.png",
